...
var App = angular.module('murdockEducations', ['angular-img-cropper','ngRoute', 'ngAnimate', 'ngStorage', 'ngCookies', 'pascalprecht.translate', 'ui.bootstrap', 'ui.router', 'oc.lazyLoad', 'cfp.loadingBar', 'ngSanitize', 'ngResource', 'ui.utils', 'chart.js', 'angularChart','ui.mask'])
    .run(["$rootScope", "$state", "$stateParams", '$window', '$templateCache', function ($rootScope, $state, $stateParams, $window, $templateCache) {
        ...
        // -----------------------------------
        $rootScope.app = {
            name: 'Murdock Educations',
            description: 'Murdock Educations.',
